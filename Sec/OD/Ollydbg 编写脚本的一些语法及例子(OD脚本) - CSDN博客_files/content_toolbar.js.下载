        ...
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="userLogin">\
                <div class="loginCenter"><a href="http://blog.csdn.net/'+currUser.userName +'"><img class="login_img" src="'+currUser.avatar+'"><div class="toolbar-circle"></div><span class="userName">'+currUser.userNick+'</span><i class="iconfont-toolbar toolbar-xiajiantou"></i></a></div>\
                <div class="userControl">\
                  <div><a href="http://my.csdn.net?ref=toolbar" target="_blank">主页</a></div>\
                  <div><a class="xiaoxi" href="http://msg.csdn.net/letters?ref=toolbar" target="_blank">消息<span class="toolbar-newsL">(3)</span></a></div>\
    ...
    $.ajax({
      ...
      success: function (json) {
        if(json.count > 0){
          ...
          $('.toolbar-newsL').html('('+length+')').fadeIn();
